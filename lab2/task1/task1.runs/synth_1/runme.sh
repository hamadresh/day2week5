...
HD_PWD='/home/it/digital_system/Digital_System_Design/lab1/task1/task1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and4input.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and4input.tcl
