...
HD_PWD='/home/it/digital_system/Digital_System_Design/lab2/task1/task1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and4input.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and4input.tcl -notrace
